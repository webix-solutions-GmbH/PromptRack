...
// `assert_tool_config` (`backend/app/services/tool_config.py`, Task 3.4)
// would refuse, the moment a toolset is picked — before either a save or a
// run round-trips to the server.
