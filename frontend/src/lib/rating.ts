// The manual rating vocabulary, in one place. The wire values are
// `good` / `meh` / `bad`; the small severity/emoji lookup below is what the
// Vue components use for styling.
//
